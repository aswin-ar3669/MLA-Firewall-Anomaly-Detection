# python test_model.py --test_csv ./data/firewall_test.csv --iso_model ./models/model_isolation_forest.joblib --clf_model ./models/model_gb_classifier.joblib --outdir ./models/Visualization
